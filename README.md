...
New York, NY<br>
   ...
   ●   Ruby on Rails - Engineered album pre-save feature so fans could pre-save album to their Spotify account.  Did multiple mobile-friendly Sass styled sites from designer mockup, with features such as: save newsletter signup to database and display flash alert, superimpose game screenshot over iPhone and iPad outlines and have mobile responsive.<br>
