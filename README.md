...
New York, NY<br>
   ...
   ●   Integrate Auth0 authentication in order to quickly allow login via email or Facebook login, as well as reset password.  Make synchronous API call in custom field validator function to make sure username is unique.  Decode JavaScript Web Token on backend<br>
