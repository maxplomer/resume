...
New York, NY<br>
   ●   Crafed a great user experience for commercial real-estate brokers with an HTML / JS front-end and straightforward JSON API routes customized for the front-end to consume<br>
