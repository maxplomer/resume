...
Projects:
 - { project: Carbon Footprint.co,  source: github.com/maxplomer/carbon-calculator,  date: May 2015,  highlights: [
...
'Sent result of footprint calculation, coded in Ruby, to the AngularJS front-end via API as an attribute in the ActiveModel Serializer' ]}
 ...
 - { project: Andrew Talty.tv,  source: github.com/maxplomer/andrewtaltytv,  date: Apr 2015,  highlights: [
...
'Created a subtle effect by blurring social media and video control buttons using the text-shadow CSS attribute' ]}
 ...
 - { project: JavaScript Sandbox.com,  source: github.com/maxplomer/javascript_sandbox,  date: Dec 2014,  highlights: [
'Used Constructed online code testing environment using Ruby on Rails and Backbone.js, great for evaluating HTML, CSS and JavaScript code in the browser',
...
'Selected the Bootstrap navbar component to create an intuitive site navigation' ]}
 ...
 - { project: Real Estate Tracker.co,  source: github.com/maxplomer/real_estate_tracker,  date: Dec 2014,  highlights: [
...
'Communicated data to API using jQuery Ajax requests from within the Ruby on Rails rendered view' ]}
 ...
 - { project: Coding Challenges.co,  source: github.com/maxplomer/coding_challenges,  date: Nov 2014,  highlights: [
...
'Jailed user-submitted code as to only permit safe method calls' ]}
 ...
 - { project: Bit Chart.co,  source: github.com/maxplomer/finance-clone,  date: Nov 2014,  highlights: [
...
'Graphed user portfolio performance using Highcharts pure JavaScript library; calculated chart data using algorithm optimized for least SQL queries' ]}
 ...
 - { project: Clean Fuel Chemical Kinetics,  fuel-specific packages available at: combustionhelp.com, dates: June 2013 - Dec 2013,  highlights: [
...
- <a href="https://github.com/maxplomer/backbone-journal-app">backbone journal app</a> - Design a Journal App using Rails on the backend and Backbone on the frontend.
...
&#32;
&#32;
<b>My Chemical Kinetics Software: </b><br>
